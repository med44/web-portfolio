...
<!--End navigation include file - - - - - - - - - - - - - - - - - - - - - -  -->
		    ...
		    <div class="row">
				...
				<div class="col-lg-4 col-lg-pull-8 col-md-4 col-md-pull-8 col-sm-12 col-xs-12 intro">
					...
					<h2>Nikelab <small>2002-05</small></h2>
						<div class="spacer">&nbsp</div>
					<p>A website featuring creative works from artists interpreting Nike products as a source for storytelling or interactive experiences.</br></br>
						This grounbreaking project at the time won a Gold Cyber Lion at Cannes and had a strong influence on digital storytelling for brands.</p>			
				</div>
			</div>      
